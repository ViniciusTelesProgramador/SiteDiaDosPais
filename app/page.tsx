  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-rose-50 text-gray-800 flex flex-col font-sans">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 flex-1 flex flex-col items-center justify-center text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-100 text-rose-600 text-xs font-bold uppercase tracking-wider mb-6">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <details
                key={item.q}
                className="group bg-gray-50 rounded-2xl border border-gray-100 px-6 py-4"
              >
                <summary className="font-bold text-gray-900 text-sm cursor-pointer list-none flex items-center justify-between">
                  <span>{item.q}</span>
                  <span className="text-indigo-400 group-open:rotate-45 transition-transform text-lg leading-none">
                    +
                  </span>
                </summary>
          ...
          <div className="text-center mt-10">
            <Link
              href="/criar"
              className="inline-flex items-center gap-2 py-4 px-8 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold transition-all shadow-lg shadow-indigo-150 hover:scale-[1.03]"
            >
