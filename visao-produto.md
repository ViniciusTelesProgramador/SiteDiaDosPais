...
| Compartilhamento gera crescimento (loop viral, Fase 2) além do link — um card visual pra Stories | Plano **Fase 7 — Card para Stories + animações de valor** (17/07/2026): botão no fechamento do storytime gera um card (Canvas) com nome/frase/foto + marca do site, share nativo com fallback de download |
